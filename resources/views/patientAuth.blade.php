                ...
                <form class="my-8">
                    <div class="relative mb-2">
                        <input id="email"
                            ...
                            type="text" autofocus>
                        <label for="email"
                            class="label absolute mt-2 ml-3 leading-tighter text-gray-600 text-base cursor-text">Email
                            or phone</label>
                    </div>
                    <div class="space-y-9">
                        <div>
                        ...
                        <div class="text-sm flex justify-between items-center">
                            <a class="font-bold text-blue-500 py-2 px-2 rounded -ml-2 hover:bg-blue-50 hover:text-blue-700"
                                href="#">Create account</a>
                            <form action="{{url('dashboard/patient/auth/google')}}">
                                <button
                                    class="py-2 px-6 rounded text-white btn bg-blue-500 hover:bg-blue-600">Next</button>
                            </form>
                        </div>
                    </div>
                </form>
